      ...
      <nav className="hidden md:block fixed top-0 left-0 w-full z-50 bg-primary/80 backdrop-blur-xl border-b border-muted/30 shadow-md">
        <div className="flex items-center justify-between px-10 py-5">
          ...
          <ul className="flex gap-10 text-light font-medium text-lg">
            <li>
              <Link to="/" className="hover:text-[#C76A46]">
                Home
              </Link>
            </li>

            <li>
              <Link to="/market" className="hover:text-[#C76A46]">
                Market
              </Link>
            </li>

            <li>
              <Link to="/sell" className="hover:text-[#C76A46]">
                Rent / Sell
              </Link>
            </li>
            ...
            {isLoggedIn && (
              <li>
                <Link to="/my-listings" className="hover:text-[#C76A46]">
                  My Listings
                </Link>
              </li>
            )}
            ...
            <li>
              <Link to="/settings" className="hover:text-[#C76A46]">
                Settings
              </Link>
            </li>
          </ul>
    ...
    {(isHomePage || isMarketPage) && isLoggedIn && (
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 bg-primary/95 backdrop-blur-xl border-t border-muted/30">
        <div className="flex justify-around items-center py-2">
          ...
          <NavLink
            to="/sell"
            className="bg-accent text-primary rounded-full p-4 -mt-6 shadow-lg"
          >
